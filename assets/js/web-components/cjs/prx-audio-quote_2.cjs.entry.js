...
const PrxAudioQuote = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '74f06bf3650cb6aef2d9a475861360c8478f3af7', playing: playing, highlight: hasTranscript, style: { '--prx-audio-quote--progress': `${progress}` } }, index.h("blockquote", { key: '95b07959051fa81768d6847af828b75de9447c4a' }, index.h("prx-quote", { key: 'd7873dcf4513ec1cefe25cfac30e25768da9550a' }, index.h("slot", { key: 'a7a5930c5311c1173a0f6abedca3ca05c9e4a1fe' })), index.h("cite", { key: '22a9e2ed15e369a373f552461c0412e03d3b5a0d' }, index.h("slot", { key: '4069a921dbf7bd7696aebd5d06a3bfa619dd1ce3', name: 'citation' })), hasAudio && (index.h("prx-audio-quote-controls", { key: '98cfa6ba1083002a9c37bc2fb5b16b508a43f11a' }, index.h("button", { key: 'fe9e35661eef8dd7cccb4b376050b55548d15d95', type: "button", class: "restart-button", onClick: handleRestartClick, "aria-label": "Restart" }), index.h("button", { key: '708798bd751ab6494bf7e1968b72837ef744b0ed', type: "button", class: "play-button", onClick: handlePlayToggleClick, "aria-label": playing ? 'Pause' : 'Play' }, index.h("span", { key: 'f3e256f4a18b9fc05c71809b06eaa0ffc1ad6b23', class: "play-icon" })))))));
    }
};
